...
[![PyPI](https://img.shields.io/pypi/v/cognis-dripcheck.svg)](https://pypi.org/project/cognis-dripcheck/)
[![CI](https://github.com/cognis-digital/dripcheck/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/dripcheck/actions)
...
DRIPCHECK exists for one job — lint email sequences and drip campaigns for deliverability: spf/dkim/dmarc, link health, unsubscribe presence, and can-spam/gdpr compliance. — and does it without a SaaS bill or heavyweight setup.
...
```bash
dripcheck --version
dripcheck scan .                      # scan the current project
dripcheck scan . --format json
dripcheck scan . --fail-on high       # non-zero exit for CI gates
dripcheck mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **mail-tester.com + textlint, echoing GlockApps**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`dripcheck` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
