#!/usr/bin/env sh
# Universal installer for dripcheck. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/dripcheck.git"
echo "Installing dripcheck ..."
